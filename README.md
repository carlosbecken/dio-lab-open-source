...
4. Crie uma nova **branch** e nomeie como `feat/community/carlosbecken`: `git checkout -b feat/community/carlosbecken`;
    > Exemplo: `git checkout -b feat/community/carlosbecken`
